...
"""
from livekit.api import LiveKitAPI, ListRoomsRequest, CreateRoomRequest, DeleteRoomRequest
...
async def delete_room(name: str):
    ...
    api_secret=LIVEKIT_API_SECRET
        ...
        response = await lkapi.room.delete_room(DeleteRoomRequest(room=name,))
        return response
