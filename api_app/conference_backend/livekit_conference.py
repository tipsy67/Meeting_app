...
async def create_livekit_conference(conference: ConferenceCreateModel) -> ConferenceOutputModel | ErrorResponseModel:
    ...
    conference_db = ConferenceModel(
        id=conference.id,
        speaker=ConferenceParticipant(**ConferenceParticipantCreate.model_dump(speaker)),
        listeners=[ConferenceParticipant(**ConferenceParticipantCreate.model_dump(user)) for user in listeners],
